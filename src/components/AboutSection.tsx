...
const highlights = [
  {
    icon: GraduationCap,
    title: "Education",
    text: "Diploma in CSE from Panimalar Polytechnic College • Currently pursuing B.E. in CSE at Panimalar Engineering College (Pre-final year)",
  },
  {
    icon: Code,
